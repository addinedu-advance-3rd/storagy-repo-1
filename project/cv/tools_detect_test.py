...
class ObjectDetect:
    ...
    def create_log(self, tool_name, user_name, rental_date):
        ...
        with app.app_context():
            ...
            if tool is None:
                ...
                print("도구 찾았다")
                new_log = Log(
                    tool_id=tool.id, user_name=user_name, rental_date=rental_date
                )
    ...
    def detect_objects(self, stop_event):
        ...
        try:
            ...
            print("ObjectDetect camera released.")
